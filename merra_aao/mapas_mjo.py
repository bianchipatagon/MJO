...
for k, ax in enumerate(axes):
  ...
  im = ax.pcolormesh(ds['lon'].data, ds['lat'].data, ds[field].data, shading='nearest', cmap = 'PuOr' )
  ...
  ax.plot(lons_s, lats_s, 'o', color='orange', ms="2", transform=ccrs.PlateCarree(), zorder=101, alpha = 0.7)
...
plt.savefig('KT.png',bbox_inches="tight", dpi=600)
