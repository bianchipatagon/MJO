...
res = sns.heatmap(Vargver,cmap=custom_cmap, ax=ax1, yticklabels=['1', '2', '3', '4', '5', '6', '7', '8'], vmin =-14, vmax=14,cbar=False, annot=annot_matrix, fmt='', annot_kws={'size': 12, 'color': 'black','va': 'center'})
...
res = sns.heatmap(Vargoto, cmap=custom_cmap, ax=ax3,yticklabels=['1', '2', '3', '4', '5', '6', '7', '8'], vmin =-14, vmax=14,cbar=False)
for _, spine in res.spines.items():
    spine.set_visible(True)
    spine.set_linewidth(1)
...
res = sns.heatmap(Varginv,cmap=custom_cmap, ax=ax5, yticklabels=['1', '2', '3', '4', '5', '6', '7', '8'], vmin =-14, vmax=14,cbar=False, annot=annot_matrix, fmt='', annot_kws={'size': 12, 'color': 'black','va': 'center_baseline'})
for _, spine in res.spines.items():
    spine.set_visible(True)
    spine.set_linewidth(1)
...
res = sns.heatmap(Vargpri, cmap=custom_cmap, ax=ax7, yticklabels=['1', '2', '3', '4', '5', '6', '7', '8'], vmin =-14, vmax=14,cbar=False, annot=annot_matrix, fmt='', annot_kws={'size': 12, 'color': 'black','va': 'center_baseline'})
for _, spine in res.spines.items():
    spine.set_visible(True)
    spine.set_linewidth(1)
...
res = sns.heatmap(Vuruver, cmap=custom_cmap, ax=ax2, yticklabels=['1', '2', '3', '4', '5', '6', '7', '8'], vmin =-14, vmax=14,cbar=False, annot=annot_matrix, fmt='', annot_kws={'size': 12, 'color': 'black','va': 'center_baseline'})
for _, spine in res.spines.items():
    spine.set_visible(True)
    spine.set_linewidth(1)
...
res = sns.heatmap(Vuruoto,cmap=custom_cmap, ax=ax4,yticklabels=['1', '2', '3', '4', '5', '6', '7', '8'], vmin =-14, vmax=14,cbar=False, annot=annot_matrix, fmt='', annot_kws={'size': 12, 'color': 'black','va': 'center_baseline'})
for _, spine in res.spines.items():
    spine.set_visible(True)
    spine.set_linewidth(1)
...
res = sns.heatmap(Vuruinv, cmap=custom_cmap, ax=ax6, yticklabels=['1', '2', '3', '4', '5', '6', '7', '8'], vmin =-14, vmax=14,cbar=False, annot=annot_matrix, fmt='', annot_kws={'size': 12, 'color': 'black','va': 'center_baseline'})
for _, spine in res.spines.items():
    spine.set_visible(True)
    spine.set_linewidth(1)
...
res = sns.heatmap(Vurupri, cmap=custom_cmap, ax=ax8, yticklabels=['1', '2', '3', '4', '5', '6', '7', '8'], vmin =-14, vmax=14,cbar=False, annot=annot_matrix, fmt='', annot_kws={'size': 12, 'color': 'black','va': 'center_baseline'})
for _, spine in res.spines.items():
    spine.set_visible(True)
    spine.set_linewidth(1)
