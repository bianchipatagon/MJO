...
### removemos tendencia demanda
stl = STL(seriesC[2], seasonal=13, period = 365, robust=True) 
result = stl.fit()
original_mean = seriesC[2].mean()
seriesC[2] = seriesC[2] - result.trend + original_mean

seriesC[3] = tempchi[3] # temp
...
##### ver
kdeplot = sns.regplot(ax=ax1,x = float_tverA, y = float_dverA, scatter_kws = {"color": "black", "alpha": 0.3, 's': 8},line_kws = {"color": "black",'lw': 1}, ci= None, label=None)
...
##### oto
kdeplot = sns.regplot(ax=ax4,x=float_totoA, y = float_dotoA, order=2, scatter_kws = {"color": "black", "alpha": 0.3, 's': 8}, line_kws = {"color": "black",'lw': 1}, ci= None, label=None)
...
##### inv
kdeplot = sns.regplot(ax=ax7,x=float_tinvA, y = float_dinvA, scatter_kws = {"color": "black", "alpha": 0.3, 's': 8}, line_kws = {"color": "black",'lw': 1}, ci= None, label=None)
...
##### pri
kdeplot = sns.regplot(ax=ax10,x=float_tpriA, y = float_dpriA, order=2, scatter_kws = {"color": "black", "alpha": 0.3, 's': 8}, line_kws = {"color": "black",'lw': 1}, ci= None, label=None)
...
##### ver
kdeplot = sns.regplot(ax=ax2,x = float_tverU, y = float_dverU, scatter_kws = {"color": "black", "alpha": 0.3, 's': 8},line_kws = {"color": "black",'lw': 1}, ci= None, label=None)
r = np.corrcoef(float_tverU, float_dverU)
ax2.tick_params(labelsize=14)
ax2.text(15, 40,'r=', fontsize=15)
ax2.text(17, 40, round(r[0, 1], 2), fontsize=15)
ax2.set_title('Uruguay', fontsize = 14, weight='bold')
ax2.set_ylim(20, 45)

##### oto
kdeplot = sns.regplot(ax=ax5,x=float_totoU, y = float_dotoU, order=2, scatter_kws = {"color": "black", "alpha": 0.3, 's': 8}, line_kws = {"color": "black",'lw': 1}, ci= None, label=None)
...
##### inv
kdeplot = sns.regplot(ax=ax8,x=float_tinvU, y = float_dinvU, scatter_kws = {"color": "black", "alpha": 0.3, 's': 8}, line_kws = {"color": "black",'lw': 1}, ci= None, label=None)
r = np.corrcoef(float_tinvU, float_dinvU)
ax8.tick_params(labelsize=14)
ax8.text(12.5, 40,'r=', fontsize=15)
ax8.text(14, 40, round(r[0, 1], 2), fontsize=15)
ax8.set_ylim(20, 45)

##### pri
kdeplot = sns.regplot(ax=ax11,x=float_tpriU, y = float_dpriU, order=2, scatter_kws = {"color": "black", "alpha": 0.3, 's': 8}, line_kws = {"color": "black",'lw': 1}, ci= None, label=None)
...
# SEGUNDA FILA; CHILE
##### ver
kdeplot = sns.regplot(ax=ax3,x = float_tverC, y = float_dverC, scatter_kws = {"color": "black", "alpha": 0.3, 's': 8},line_kws = {"color": "black",'lw': 1}, ci= None, label=None)
r = np.corrcoef(float_tverC, float_dverC)
ax3.tick_params(labelsize=14)
# ~ ax9.text(16, 550,'r=', fontsize=15)
# ~ ax9.text(18, 550, round(r[0, 1], 2), fontsize=15)
ax3.set_title('Chile', fontsize = 14, weight='bold')
ax3.set_ylim(155, 260)

##### oto
kdeplot = sns.regplot(ax=ax6,x=float_totoC, y = float_dotoC, order=2, scatter_kws = {"color": "black", "alpha": 0.3, 's': 8}, line_kws = {"color": "black",'lw': 1}, ci= None, label=None)
r = np.corrcoef(float_totoC, float_dotoC)
ax6.tick_params(labelsize=14)
# ~ ax2.text(-2.4, 185,'r=', fontsize=15)
# ~ ax2.text(-1.8, 185, round(r[0, 1], 2), fontsize=15)
ax6.set_ylim(155, 260)

##### inv
kdeplot = sns.regplot(ax=ax9,x=float_tinvC, y = float_dinvC, scatter_kws = {"color": "black", "alpha": 0.3, 's': 8}, line_kws = {"color": "black",'lw': 1}, ci= None, label=None)
...
##### pri
kdeplot = sns.regplot(ax=ax12,x=float_tpriC, y = float_dpriC, order=2, scatter_kws = {"color": "black", "alpha": 0.3, 's': 8}, line_kws = {"color": "black",'lw': 1}, ci= None, label=None)
...
fig.text(0.45, 0.08, 'temperature [°c]', fontsize = 15)
fig.text(0.91, 0.79, 'DJF', fontsize = 14, rotation='vertical')
fig.text(0.91, 0.59, 'MAM', fontsize = 14, rotation='vertical')
fig.text(0.91, 0.41, 'JJA', fontsize = 14, rotation='vertical')
fig.text(0.91, 0.19, 'SON', fontsize = 14, rotation='vertical')
fig.text(0.05, 0.42, 'power demand [MWh]', fontsize=15, rotation='vertical')

fig.subplots_adjust(bottom=0.13)
# ~ fig.subplots_adjust(left=0.15)

plt.savefig('/home/emi/Documents/MJO/imagenes/scatter_temp.jpg', dpi=300, bbox_inches="tight")
# ~ plt.show()
