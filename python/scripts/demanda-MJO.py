...
Vchi = pd.read_csv('/home/emi/Dropbox/DTEC/MJO/datos/ajuste/chi-dem_agrup.csv', header=None, delimiter=',', na_values='-99')
...
sns.heatmap(Vargver,cmap=custom_cmap, ax=ax1, yticklabels=['1', '2', '3', '4', '5', '6', '7', '8'], vmin = -2.5, vmax = 2.5,cbar=False, annot=annot_matrix, fmt='', annot_kws={'size': 12, 'color': 'black','va': 'center'})
ax1.set_yticklabels(ax1.get_yticklabels(), rotation=0)
ax1.xaxis.set_tick_params(length=0)

annot_matrix = N.where(Pargoto < 0.05, '*', '')
sns.heatmap(Vargoto, cmap=custom_cmap, ax=ax4,yticklabels=['1', '2', '3', '4', '5', '6', '7', '8'], vmin = -2.5, vmax = 2.5,cbar=False)
ax4.set_yticklabels(ax4.get_yticklabels(), rotation=0)
ax4.xaxis.set_tick_params(length=0)

annot_matrix = N.where(Parginv < 0.05, '*', '')
sns.heatmap(Varginv,cmap=custom_cmap, ax=ax7, yticklabels=['1', '2', '3', '4', '5', '6', '7', '8'], vmin = -2.5, vmax = 2.5,cbar=False, annot=annot_matrix, fmt='', annot_kws={'size': 12, 'color': 'black','va': 'center_baseline'})
ax7.set_yticklabels(ax7.get_yticklabels(), rotation=0)
ax7.xaxis.set_tick_params(length=0)

annot_matrix = N.where(Pargpri < 0.05, '*', '')
sns.heatmap(Vargpri, cmap=custom_cmap, ax=ax10, yticklabels=['1', '2', '3', '4', '5', '6', '7', '8'], vmin = -2.5, vmax = 2.5,cbar=False, annot=annot_matrix, fmt='', annot_kws={'size': 12, 'color': 'black','va': 'center_baseline'})
ax10.set_yticklabels(ax10.get_yticklabels(), rotation=0)

ax2.set_title('Uruguay', fontsize=13)
annot_matrix = N.where(Puruver < 0.05, '*', '')
sns.heatmap(Vuruver, cmap=custom_cmap, ax=ax2, yticklabels=['1', '2', '3', '4', '5', '6', '7', '8'], vmin = -2.5, vmax = 2.5,cbar=False, annot=annot_matrix, fmt='', annot_kws={'size': 12, 'color': 'black','va': 'center_baseline'})
ax2.xaxis.set_tick_params(length=0)
ax2.yaxis.set_tick_params(length=0)

annot_matrix = N.where(Puruoto < 0.05, '*', '')
sns.heatmap(Vuruoto,cmap=custom_cmap, ax=ax5,yticklabels=['1', '2', '3', '4', '5', '6', '7', '8'], vmin = -2.5, vmax = 2.5,cbar=False, annot=annot_matrix, fmt='', annot_kws={'size': 12, 'color': 'black','va': 'center_baseline'})
ax5.xaxis.set_tick_params(length=0)
ax5.yaxis.set_tick_params(length=0)

annot_matrix = N.where(Puruinv < 0.05, '*', '')
sns.heatmap(Vuruinv, cmap=custom_cmap, ax=ax8, yticklabels=['1', '2', '3', '4', '5', '6', '7', '8'], vmin = -2.5, vmax = 2.5,cbar=False, annot=annot_matrix, fmt='', annot_kws={'size': 12, 'color': 'black','va': 'center_baseline'})
ax8.xaxis.set_tick_params(length=0)
ax8.yaxis.set_tick_params(length=0)

annot_matrix = N.where(Purupri < 0.05, '*', '')
sns.heatmap(Vurupri, cmap=custom_cmap, ax=ax11, yticklabels=['1', '2', '3', '4', '5', '6', '7', '8'], vmin =-2, vmax=2,cbar=False, annot=annot_matrix, fmt='', annot_kws={'size': 12, 'color': 'black','va': 'center_baseline'})
ax11.yaxis.set_tick_params(length=0)

ax3.set_title('Chile', fontsize=13)
annot_matrix = N.where(Pchiver < 0.05, '*', '')
sns.heatmap(Vchiver, cmap=custom_cmap, ax=ax3, yticklabels=['1', '2', '3', '4', '5', '6', '7', '8'], vmin = -2.5, vmax = 2.5,cbar=False, annot=annot_matrix, fmt='', annot_kws={'size': 12, 'color': 'black','va': 'center_baseline'})
ax3.xaxis.set_tick_params(length=0)
ax3.yaxis.set_tick_params(length=0)

annot_matrix = N.where(Pchioto < 0.05, '*', '')
sns.heatmap(Vchioto, cmap=custom_cmap, ax=ax6,yticklabels=['1', '2', '3', '4', '5', '6', '7', '8'], vmin = -2.5, vmax = 2.5,cbar=False, annot=annot_matrix, fmt='', annot_kws={'size': 12, 'color': 'black','va': 'center_baseline'})
ax6.xaxis.set_tick_params(length=0)
ax6.yaxis.set_tick_params(length=0)

annot_matrix = N.where(Pchiinv < 0.05, '*', '')
sns.heatmap(Vchiinv, cmap=custom_cmap, ax=ax9, yticklabels=['1', '2', '3', '4', '5', '6', '7', '8'], vmin = -2.5, vmax = 2.5,cbar=False, annot=annot_matrix, fmt='', annot_kws={'size': 12, 'color': 'black','va': 'center_baseline'})
ax9.xaxis.set_tick_params(length=0)
ax9.yaxis.set_tick_params(length=0)

annot_matrix = N.where(Pchipri < 0.05, '*', '')
sns.heatmap(Vchipri, cmap=custom_cmap, ax=ax12, yticklabels=['1', '2', '3', '4', '5', '6', '7', '8'], vmin = -2.5, vmax = 2.5,cbar=False, annot=annot_matrix, fmt='', annot_kws={'size': 12, 'color': 'black','va': 'center_baseline'})
