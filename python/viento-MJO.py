...
season_defs = {
    'ver': {'months': [1, 2, 12], 'pf': {'uru': Vuru_p_v, 'arg': Varg_p_v}},
    'oto': {'months': [3, 4, 5],  'pf': {'uru': Vuru_p_o, 'arg': Varg_p_o}},
    'inv': {'months': [6, 7, 8],  'pf': {'uru': Vuru_p_i, 'arg': Varg_p_i}},
    'pri': {'months': [9, 10, 11],'pf': {'uru': Vuru_p_p, 'arg': Varg_p_p}},
}
country_cols = {'uru': 4, 'arg': 5}
...
fig, ((ax1,ax2),(ax3,ax4),(ax5,ax6),(ax7,ax8)) = plt.subplots(4, 2,figsize=(5.4,6.3), sharex= True, sharey=True)

# ~ annot_matrix = N.where(Vargver > 5  , '*', '')
annot_matrix = N.where(Pargver < 0.05, '*', '')
ax1.set_title('Argentina  ', fontsize=13)
res = sns.heatmap(Vargver,cmap=custom_cmap, ax=ax1, yticklabels=['1', '2', '3', '4', '5', '6', '7', '8'], vmin =-10.5, vmax=10.5,cbar=False, annot=annot_matrix, fmt='', annot_kws={'size': 12, 'color': 'black','va': 'center'})
...
res= sns.heatmap(Vargoto, cmap=custom_cmap, ax=ax3,yticklabels=['1', '2', '3', '4', '5', '6', '7', '8'], vmin =-10.5, vmax=10.5,cbar=False)
for _, spine in res.spines.items():
    spine.set_visible(True)
    spine.set_linewidth(1)
...
res = sns.heatmap(Varginv,cmap=custom_cmap, ax=ax5, yticklabels=['1', '2', '3', '4', '5', '6', '7', '8'], vmin =-10.5, vmax=10.5,cbar=False, annot=annot_matrix, fmt='', annot_kws={'size': 12, 'color': 'black','va': 'center_baseline'})
for _, spine in res.spines.items():
    spine.set_visible(True)
    spine.set_linewidth(1)
...
res = sns.heatmap(Vargpri, cmap=custom_cmap, ax=ax7, yticklabels=['1', '2', '3', '4', '5', '6', '7', '8'], vmin =-10.5, vmax=10.5,cbar=False, annot=annot_matrix, fmt='', annot_kws={'size': 12, 'color': 'black','va': 'center_baseline'})
for _, spine in res.spines.items():
    spine.set_visible(True)
    spine.set_linewidth(1)
...
res = sns.heatmap(Vuruver, cmap=custom_cmap, ax=ax2, yticklabels=['1', '2', '3', '4', '5', '6', '7', '8'], vmin =-10.5, vmax=10.5,cbar=False, annot=annot_matrix, fmt='', annot_kws={'size': 12, 'color': 'black','va': 'center_baseline'})
for _, spine in res.spines.items():
    spine.set_visible(True)
    spine.set_linewidth(1)
...
res = sns.heatmap(Vuruoto,cmap=custom_cmap, ax=ax4,yticklabels=['1', '2', '3', '4', '5', '6', '7', '8'], vmin =-10.5, vmax=10.5,cbar=False, annot=annot_matrix, fmt='', annot_kws={'size': 12, 'color': 'black','va': 'center_baseline'})
for _, spine in res.spines.items():
    spine.set_visible(True)
    spine.set_linewidth(1)
...
res = sns.heatmap(Vuruinv, cmap=custom_cmap, ax=ax6, yticklabels=['1', '2', '3', '4', '5', '6', '7', '8'], vmin =-10.5, vmax=10.5,cbar=False, annot=annot_matrix, fmt='', annot_kws={'size': 12, 'color': 'black','va': 'center_baseline'})
for _, spine in res.spines.items():
    spine.set_visible(True)
    spine.set_linewidth(1)
...
res = sns.heatmap(Vurupri, cmap=custom_cmap, ax=ax8, yticklabels=['1', '2', '3', '4', '5', '6', '7', '8'], vmin =-10.5, vmax=10.5,cbar=False, annot=annot_matrix, fmt='', annot_kws={'size': 12, 'color': 'black','va': 'center_baseline'})
for _, spine in res.spines.items():
    spine.set_visible(True)
    spine.set_linewidth(1)
...
cbar= fig.colorbar(sm, ax=(ax1,ax2,ax3,ax4,ax5,ax6,ax7,ax8), location='right', shrink=0.8, cax=cbar_ax)
